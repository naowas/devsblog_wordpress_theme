                ...
                <div class="col-md-4 mb-3">
                    <div class="card blog-post-card">
						...
						if ( has_post_thumbnail() ) {
							...
							?>
                            <a class="more-link"
                               href="<?php echo get_post_permalink(); ?>"><?php the_post_thumbnail( 'post-thumbnail', array( 'class' => 'img-fluid' ) ); ?></a>
							<?php
						}
						?>
                        <div class="card-body">
                            ...
                            <p class="mb-0"><a class="more-link" href="<?php echo get_post_permalink(); ?>">Read more
                                    →</a></p>
